"""Optional HTTP Basic Auth middleware for the Waygate dashboard."""
...
class BasicAuthMiddleware(BaseHTTPMiddleware):
    ...
    When *auth* credentials are provided to :func:`WaygateDashboard`, this
    ...
    def _challenge() -> Response:
        ...
        return Response(
            status_code=401,
            headers={"WWW-Authenticate": 'Basic realm="Waygate Dashboard"'},
