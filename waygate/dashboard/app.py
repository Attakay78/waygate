"""Waygate dashboard — mountable Starlette admin UI factory."""
...
def WaygateDashboard(
    engine: WaygateEngine,
    prefix: str = "/waygate",
    auth: tuple[str, str] | None = None,
) -> ASGIApp:
    """Create a mountable Starlette admin UI for the Waygate engine.

    Mount it on any FastAPI / Starlette application::

        app.mount("/waygate", WaygateDashboard(engine=engine))
    ...
    ----------
    engine:
        The :class:`~waygate.core.engine.WaygateEngine` whose state this
